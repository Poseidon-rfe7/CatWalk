...
class AddAReview extends React.Component {
  constructor(props) {
    ...
    this.characteristicClickHandler =
      this.characteristicClickHandler.bind(this);
    ...
    this.formModalCloseClickHandler =
      this.formModalCloseClickHandler.bind(this);
    this.resetForm = this.resetForm.bind(this);
    this.radioTracker = this.radioTracker.bind(this);
    this.getFile = this.getFile.bind(this);
    this.minimumCharacterChangehandler =
      this.minimumCharacterChangehandler.bind(this);
  }
        ...
        <div className='add-review-container modal-content-form'>
          <form action='action_page.php'>
            ...
            <div className='row'>
              <div className='col-26'>
                <div className='row-inner-container'>
                  ...
                  />
                  <label className='row-inner-elements'>
                ...
                <div className='row-inner-container'>
                  <div className='item'>
                    <div className='item-inner'>
                      <label htmlFor='fname' className='row-inner-elements'>
            ...
            <div className='row row-inner-elements'>
              <div className='col-26'>
                <div className='row-inner-container'>
                  ...
                  <textarea
                    className='shrink-right row-inner-elements'
                    name='review-summary'
            ...
            <div className='row form-buttons'>
              <button
                onClick={this.formModalCloseClickHandler}
                className='form-btn'
              >
                Cancel
              </button>
