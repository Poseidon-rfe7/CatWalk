    ...
    return (
      <div className='ratings-breakdown-container'>
        ...
        <div className='star-progress-bar-container'>
          <p className='star-underline' onClick={this.props.starFilterClickHandler}>5 stars</p>
        ...
        <div className='star-progress-bar-container'>
          <p className='star-underline' onClick={this.props.starFilterClickHandler}>4 stars</p>
        ...
        <div className='star-progress-bar-container'>
          <p className='star-underline' onClick={this.props.starFilterClickHandler}>3 stars</p>
        ...
        <div className='star-progress-bar-container'>
          <p className='star-underline' onClick={this.props.starFilterClickHandler}>2 stars</p>
        ...
        <div className='star-progress-bar-container'>
          <p className='star-underline' onClick={this.props.starFilterClickHandler}>1 stars</p>
