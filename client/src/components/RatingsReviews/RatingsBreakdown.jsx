...
class RatingsBreakdown extends React.Component {
  ...
  componentDidUpdate(prevProps) {
    if (
      prevProps.meta.product_id === undefined &&
      !Array.isArray(this.props.meta)
    ) {
      this.totalRatings();
    }
    if (
      !Array.isArray(this.props.meta) &&
      prevProps.meta.product_id !== this.props.meta.product_id
    ) {
      this.totalRatings();
    }
  }
  ...
  totalRatings() {
    ...
    let weightedAverageRoundedStarComponent = (
      Math.round(weightedAverageRounded * 4) / 4
    ).toFixed(2);
    ...
    if (this.props.meta.ratings) {
      this.setState({
        ...
        totalRatings: total,
        roundedAvg: weightedAverageRounded,
        roundedAvgStarComponent: weightedAverageRoundedStarComponent,
        recommend: recommendedAverage,
      });
    }
  }
    ...
    return (
      <div className='ratings-breakdown-container'>
        ...
        <div className='star-progress-bar-container'>
          <p
            className='star-underline'
            onClick={this.props.starFilterClickHandler}
          >
            5 stars
          </p>
          <Progressbar
