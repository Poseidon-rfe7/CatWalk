    ...
    return (
      <div className='ratings-breakdown-container'>
        ...
        <div className='star-progress-bar-container'>
          <p className='star-underline'>5 stars</p>
        ...
        <div className='star-progress-bar-container'>
          <p className='star-underline'>4 stars</p>
        ...
        <div className='star-progress-bar-container'>
          <p className='star-underline'>3 stars</p>
        ...
        <div className='star-progress-bar-container'>
          <p className='star-underline'>2 stars</p>
        ...
        <div className='star-progress-bar-container'>
          <p className='star-underline'>1 stars</p>
