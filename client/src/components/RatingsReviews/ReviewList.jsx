...
function ReviewList(props) {
  ...
  if (props.filters.length > 0) {
    let reviews = props.product.filter((review) => props.filters.includes(review.rating.toString()))
  ...
  return (
    <div className='review-list-scroll'>
      ...
      {filteredReviews.map((review) => <IndividualReviewTile key={review.review_id} review={review} helpfulClickHandler={props.helpfulClickHandler} />)}
